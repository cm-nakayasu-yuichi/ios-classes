...
extension AlertPresentable where Self: UIViewController {
    ...
    ///   - message: メッセージ
    ///   - whenOk: OKを押下したときの処理
    func showErrorDialog(message: String?, whenOk: (() -> ())? = nil) {
    ...
    ///   - title: タイトル
    ///   - whenOk: OKを押下したときの処理
    func showOkDialog(message: String?, title: String? = nil, whenOk: (() -> ())? = nil) {
    ...
    func showOkCancelDialog(message: String?, title: String? = nil, whenOk: (() -> ())? = nil, whenCancel: (() -> ())? = nil) {
        showAlertDialog(message: message, title: title, actions: [
            UIAlertAction(title: "OK", style: .default, handler: { _ in whenOk?() }),
    ...
    func showYesNoDialog(message: String?, title: String? = nil, whenYes: (() -> ())? = nil, whenNo: (() -> ())? = nil) {
        showAlertDialog(message: message, title: title, actions: [
    ...
    ///   - whenCancel: キャンセルを押下したときの処理
    func showDeleteCancelDialog(message: String?, title: String? = nil, whenDelete: (() -> ())? = nil, whenCancel: (() -> ())? = nil) {
        showAlertDialog(message: message, title: title, actions: [
    ...
    func showAlertDialog(message: String?, title: String?, actions: [UIAlertAction]) {
